 ...
 * @example <caption>Example usage with single tag</caption>
 * // returns
 * // {
 * //     "rfc5646": "en-US",
 * //     "region": {
 ...
 * @returns {Object[]|Void} object contain details on the tags, keyed on the language tag, or undefined for undefined input
 */
const languageInfo = value => {
  ...
  const response = { rfc5646: null, region: {}, language: {} };
  ...
  response.region = countriesList.countries[langTag.region];
